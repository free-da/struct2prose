...
def main() -> None:
    ...
    p_root.add_argument("--db-path", type=Path, default=Path("state/struct2prose.db"))
    ...
    p_ui.add_argument("--db-path", type=Path, default=Path("state/struct2prose.db"))
    ...
    p_parse.add_argument("--db-path", type=Path, default=Path("state/struct2prose.db"))
    ...
    p_norm.add_argument("--db-path", type=Path, default=Path("state/struct2prose.db"))
